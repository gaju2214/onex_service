    ...
    return (
        <section id="contact" className="scroll-mt-24 border-t border-border py-16 md:py-24" aria-label="Contact">
            <div className="mx-auto max-w-6xl px-4">
                ...
                <div className="mt-8 flex justify-center">
                    <a
                        ...
                        className="inline-flex items-center justify-center rounded-2xl px-8 py-4 text-lg font-semibold text-foreground ring-1 ring-primary/20 transition hover:animate-pulse bg-gradient-to-r from-[var(--brand-saffron)] to-[var(--brand-green)]"
                    >
            ...
            <a
                ...
                className="fixed bottom-6 right-6 z-40 inline-flex h-12 w-12 items-center justify-center rounded-full text-foreground shadow-lg ring-1 ring-primary/20 transition hover:shadow-[0_0_28px] hover:shadow-primary/40 bg-gradient-to-br from-[var(--brand-saffron)] to-[var(--brand-green)]"
            >
