            ...
            <div className="mx-auto max-w-6xl px-4">
                ...
                <div className="mt-8 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-6">
                    {clientCategories.map((category, i) => {
                        ...
                        const cardClasses = "flex h-full flex-col items-center gap-2 rounded-2xl border border-border bg-foreground/5 p-4 text-center backdrop-blur"
                        const content = (
                            <>
                        ...
                        return (
                            ...
                            >
                                {category.to ? (
                                    <Link to={category.to} className={`${cardClasses} transition-transform hover:-translate-y-1`}>
                                        {content}
                                    </Link>
                                ) : (
